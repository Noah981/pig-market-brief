  ...
  Widget build(BuildContext context) => Container(
        ...
        child: Row(children: List.generate(4, (i) => Expanded(child: InkWell(
          ...
          child: AnimatedContainer(duration: const Duration(milliseconds: 180), alignment: Alignment.center,
            ...
            child: Text(['일간','주간','월간','연간'][i], style: TextStyle(fontSize: 10, fontWeight: i == selected ? FontWeight.w800 : FontWeight.w500, color: i == selected ? AppColors.coral : AppColors.secondary))),
        )))),
      );
}
