...
class MarketPriceCard extends StatelessWidget {
  const MarketPriceCard({super.key, required this.period, required this.series, required this.onPeriodChanged,this.snapshot,this.onRefresh});
  final int period;
  ...
  Widget build(BuildContext context) => Container(
    ...
    child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      ...
      const SizedBox(height:7),PriceLineChart(values:period==0&&snapshot!=null?snapshot!.history:series[period].values),const SizedBox(height:3),PeriodTabBar(selected:period,onChanged:onPeriodChanged),const SizedBox(height:6),
