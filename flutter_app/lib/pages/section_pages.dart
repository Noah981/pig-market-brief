...
class _DiseasePageState extends State<DiseasePage> {
  ...
  @override
  Widget build(BuildContext context) {
    const outbreaks = ['ASF  |  경북 영주시  |  2025.09.15', 'PED  |  충남 논산시  |  2025.09.14', 'PRRS |  경기 이천시  |  2025.09.12', 'ASF  |  강원 철원군  |  2025.09.10'];
    return PageShell(
...
class _FarmCheckPageState extends State<FarmCheckPage> {
  ...
  Widget build(BuildContext context) => PageShell(
    ...
    child: Column(children: [
      ...
      const Row(children: [Expanded(child: Text('점검 항목 (분만사)', style: TextStyle(fontSize: 13, fontWeight: FontWeight.w900))), Text('2025.09.18 (목)', style: TextStyle(fontSize: 9, color: AppColors.secondary))]),
