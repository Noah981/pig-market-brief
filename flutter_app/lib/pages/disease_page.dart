...
class _DiseasePageState extends State<DiseasePage>{
  final _repository=DiseaseRepository();DiseaseFeed? _feed;int _tab=0;double? _lat,_lng;bool _gpsVerified=false;String _location='위치 설정';String? _message;
  ...
  Future<void> _useGps()async{
    ...
    await FarmLocationSettings.instance.setGps(p.latitude,p.longitude);if(mounted)setState(()=>_message=null);
  }
  Future<void> _pickRegion()async{await showFarmLocationPicker(context);if(mounted)setState(()=>_message=null);}
